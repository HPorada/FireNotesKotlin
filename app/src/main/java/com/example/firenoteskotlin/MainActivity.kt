...
import com.example.firenoteskotlin.auth.Register
import com.example.firenoteskotlin.model.Note
import com.example.firenoteskotlin.note.AddNote
import com.example.firenoteskotlin.note.EditNote
import com.example.firenoteskotlin.note.NoteDetails
            ...
            protected override fun onBindViewHolder(
                ...
                menuIcon.setOnClickListener { view ->
                    ...
                    menu.menu.add("Delete").setOnMenuItemClickListener {
                        val docref = fStore!!.collection("notes").document(docId)
